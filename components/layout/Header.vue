  ...
  methods: {
    ...
    setRoutesNames(routeName: string) {
      this.pageTitle =
        routeName === 'index'
          ? 'Dashboard'
          : routeName === 'Listings-Verified'
          ? 'Verfied Listings'
          : routeName === 'Listings-Unverified'
          ? 'Unverfied Listings'
          : routeName === 'Listers-Verified'
          ? 'Verfied Listers'
          : routeName === 'Listers-Unverified'
          ? 'Unverfied Listers'
          : routeName === 'Users-Verified'
          ? 'Verfied Users'
          : routeName === 'Users-Unverified'
          ? 'Unverfied Users'
          : routeName === 'Plans-Active'
          ? 'Active Plans'
          : routeName === 'Plans-DeActive'
          ? 'Deactive Plans'
          : routeName === 'property_types'
          ? 'Property Types'
