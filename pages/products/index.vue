    ...
    <el-card>
      <el-tabs v-model="activeTab" type="card">
        <el-tab-pane name="pendingReview">
          <span slot="label"
            ><i class="el-icon-video-pause"></i> {{ pendingTab }}</span
          >
          <el-row :gutter="10" class="mb-2 mt-10">
            <el-col :sm="22" :md="24">
              <el-input
                v-model="search"
              ...
              <el-table-column type="expand">
                <template #default="props">
                  <p>
                    ...
                    adipisicing elit. Rerum corporis repellendus incidunt iure
                    vitae magni blanditiis eaque reiciendis iusto sapiente
                    magnam doloribus suscipit odit beatae, eveniet unde tenetur
                    deleniti adipisci?
                  </p>
              ...
              <el-table-column label="Vendor">
                <template slot-scope="props">
                  <div
                    ...
                    @click="viewProfile(props.row._id)"
                  >
                    <span class="mr-10">
                      <img
